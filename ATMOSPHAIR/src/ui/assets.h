...
#define SETTINGS_ACTION_WIDTH       208
#define SETTINGS_ACTION_HEIGHT      17
...
#define WIDGET_ICON_SIZE            12
#define WIDGET_ICON_WIDTH           WIDGET_ICON_SIZE
#define WIDGET_ICON_HEIGHT          WIDGET_ICON_SIZE

#define MUTE_ACTION_SIZE            24
#define MUTE_ACTION_WIDTH           MUTE_ACTION_SIZE
#define MUTE_ACTION_HEIGHT          MUTE_ACTION_SIZE
...
extern const uint8_t    SETTINGS_ACTION_ASSET[]; 
extern const uint8_t   SETTINGS_ACTION_SELECTED_ASSET[]; 
...
extern const uint8_t    MUTE_ACTION_ASSET[]; 
